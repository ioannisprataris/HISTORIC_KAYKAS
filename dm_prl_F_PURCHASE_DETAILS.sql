...
Select [Purchasing_Document_SK] from [dbo].[PURCHASE_HEADER] where ETL_Batch_ID = -3999 
union
Select [Purchasing_Document_SK] from [dbo].[PURCHASE_DETAIL] where ETL_Batch_ID = -3999 



INSERT INTO [dm_prl].[F_PURCHASE_DETAILS_hist] 
(		 
